...
/**
 * add_sep_end - puts separator node at the end of list
...
/**
 * sep_list_free - the frees a separator list
...
/**
 * add_line__end - this puts the current line at the end of thelist.
 * @head: head of the list.
 * @line: current line.
 * Return: address of head.
 */
...
/**
 * line_list_free - this frees the list
 * @head: this head of the list.
 * Return: Non
 */
