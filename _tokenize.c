...
/**
 * char_swap - this swaps | and &
 * @input: this is input
 * @bool: this is swap type
...
/**
 * add_nodes - this  adds separators and command in the lists
 * @head_s: this is the head of separator list
 * @head_l: this is the head of command lines list
 ...
 * @list_l: this is the command line list
 * @datash: shell info
 * Return: Non
 */
...
/**
 * command_split - this splits command lines
 * @datash: this the shell info
 * @input: the is the input
 * Return: 0 or 1
 */
...
/**
 * tokenize_line - this tokenizes the string
 * @input: this is the input
