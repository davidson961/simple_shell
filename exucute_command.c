...
/**
 * searchable_cdir - This checks if is searchable.
 * @path: the path to check
 * @i: the pointer of index.
 * Return: 1 or 0
 */
...
/**
 * locate_cmd -this looks for a command
 * @cmd: the cmd
...
/**
 * check_executable - this checks if it is executable
...
/**
 * check_cmd_err - this verifies if user has access
